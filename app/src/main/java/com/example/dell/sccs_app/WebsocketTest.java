...
public abstract class WebsocketTest extends WebSocketAdapter implements Runnable, WebSocket {
    protected URI uri;
    ...
    public WebsocketTest(URI serverUri, Draft protocolDraft, Map<String,String> httpHeaders, int connectTimeout) {
        this.uri = null;
        this.engine = null;
        this.socket = null;
    ...
    public void run() {
        ...
        this.writeThread = new Thread(new WebsocketTest.WebsocketWriteThread());
        this.writeThread.start();
        ...
        public void run() {
            ...
            try {
                while(!Thread.interrupted()) {
                    ByteBuffer e = (ByteBuffer)WebsocketTest.this.engine.outQueue.take();
                    WebsocketTest.this.ostream.write(e.array(), 0, e.limit());
                    WebsocketTest.this.ostream.flush();
                }
            } catch (IOException var2) {
                WebsocketTest.this.engine.eot();
